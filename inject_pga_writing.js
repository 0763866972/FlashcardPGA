...
if (!pgaHtml.includes('window.toggleWritingMode')) {
    // Find the last </script> tag
    const lastScriptIndex = pgaHtml.lastIndexOf('</script>');
    pgaHtml = pgaHtml.slice(0, lastScriptIndex) + additionalCode + '\\n' + pgaHtml.slice(lastScriptIndex);
    
    fs.writeFileSync('pga.html', pgaHtml, 'utf8');
    console.log("Successfully injected writing mode code into pga.html");
} else {
    console.log("Writing mode code already exists in pga.html");
}
